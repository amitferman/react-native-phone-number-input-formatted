...
export default class PhoneInput extends PureComponent {
  ...
  openKeyboard = () => {
    ...
    // RN Bug Workaround for Android (https://github.com/facebook/react-native/issues/19366)
    if (Platform.OS == 'android') {
      textInput.blur()
    }
    // Workaround - wait for components to render
        ...
        <View style={{width: '100%', flexDirection: 'row', justifyContent: 'center'}}>
          ...
          >
            ...
            >
              ...
              <TouchableOpacity onPress={this.openKeyboard} activeOpacity={0.5}>
